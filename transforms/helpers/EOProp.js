...
const { get, getPropName, getPropType, getModifier, isClassDecoratorProp, LAYOUT_DECORATOR_LOCAL_NAME, LAYOUT_DECORATOR_NAME, } = require('./util');
/**
...
class EOProp {
    constructor(eoProp, runtimeData, importedDecoratedProps) {
        ...
        this.decoratorArgs = {};
        if (runtimeData.type) {
            const { type, computedProperties = [], offProperties = {}, overriddenActions = [], overriddenProperties = [], unobservedProperties = {}, } = runtimeData;
            this.emberType = type;
